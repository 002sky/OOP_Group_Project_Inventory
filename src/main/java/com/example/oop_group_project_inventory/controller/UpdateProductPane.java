...
public class UpdateProductPane implements Initializable {
     ...
     * @return return true or false depending on validation
     * @throws IOException
     */
    //validation for every text field
...
//                System.out.println("product brand is empty");
        ...
        if (!TfProductID.getText().isEmpty()) {
            ...
            if (tmp.getClass().equals(com.example.oop_group_project_inventory.model.Clothing.class)) {
...
//                    System.out.println("clothing size is empty");
            ...
            if (tmp.getClass().equals(com.example.oop_group_project_inventory.model.Grocery.class)) {
...
//                    System.out.println("expiry date is empty");
            ...
            if (tmp.getClass().equals(com.example.oop_group_project_inventory.model.Electronic.class)) {
...
//                    System.out.println("model is empty");
    ...
    /**
     * update product in database and show pop up message
     * if update successfully show pop up message successfully
     * if update failed show pop up message error
     * @throws IOException
     */
...
//                            popup.show(primaryStage);
    ...
    /**
     * initialize TfProductID text field with auto complete value from MainPage.productArrayList
     * initialize TfProductID with Listener to dynamic change the form based on the product type
     */
    @Override
     ...
     * @param productID accept productID as parameter
     * @return return the index of the product in productArrayList
     */
