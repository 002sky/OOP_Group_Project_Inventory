...
import com.example.oop_group_project_inventory.model.Order;
...
public class AddOrderPane implements Initializable {
    ...
    /**
     * initialize TextFields tfOrderID with listener to check if order id already exist
     * if got existing order id show error message
     * initialize TextFields tfProductID with AutoComplete
     * if auto complete got existing product id  populate tfProductID and TfProductID, lblProductName, lblSubTotal, lblSellingPrice
     */
    @Override
     ...
     * @return return index of product in productArrayList
     */
    ...
    /**
     * check and return whether got existing order
     * @param orderID accept order id as parameter
     * @return return index of order in orderArrayList
     */
     ...
     * @return return a boolean value whether validation is true or false
     * @throws IOException
     */
    //validation for every text field
    ...
    /**
     * submit to database via mouse event and Order object
     * if validation is true submit to database
     * if validation is false show pop up message
     * @throws IOException
     */
    //add to database
