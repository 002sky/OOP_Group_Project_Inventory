...
public class UpdateInventoryPane implements Initializable {
    ...
    /**
     * initialize the text field TfInventoryID with auto complete value from Mainpage.inventoryArrayList
     * based on the inventoryID populate the text field TfInventoryName, TaInventoryAddress, CbFreezerAvailable
     */
    @Override
     ...
     * @return return true if the text field is not empty
     * @throws IOException
     */
    //validation for every text field
    ...
    /**
     * check whether got existing inventory
     * @param InventoryID accept the inventoryID as parameter
     * @return return the index of the inventoryID in the Mainpage.inventoryArrayList
     */
    ...
    /**
     * update the inventory via the inventory class
     * if the validation is true then update the inventory
     * if the validation is false then show the error message
     * @throws IOException
     */
    ////update inventory
